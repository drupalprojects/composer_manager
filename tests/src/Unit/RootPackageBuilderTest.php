...
class RootPackageBuilderTest extends UnitTestCase {
  ...
  public function testBuild() {
    ...
    // Confirm that the test3 repositories were ignored because the package
    // has no requirements.
    $this->assertTrue(!isset($root_package['repositories']));
    ...
    $this->assertEquals('drupal, test1, test2', $root_package['extra']['_sources']);
  }
}
